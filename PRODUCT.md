...
Planejadores financeiros brasileiros, em especial assinantes da Planfi, com perfil pouco técnico e uma operação carregada de e-mails, reuniões, follow-ups e tarefas repetitivas. Na área autenticada, eles precisam saber com clareza o que está disponível, o que fazer agora e o que já concluíram.
...
Honesta, humana e competente. A comunicação é direta, natural e sem hype, com limites, riscos e custos explícitos.

## Anti-references

- Dashboard genérico de SaaS cheio de métricas decorativas.
- Interface que trata planejadores como público técnico.
- Excesso de cards, efeitos ou texto promocional dentro da área de trabalho.
- Estados bloqueados ambíguos ou ações que parecem disponíveis quando não estão.
- Arquivos antigos competindo com a trilha vigente.
...
Contraste mínimo WCAG AA, foco visível, alvos interativos de pelo menos 44 px, estados que não dependem apenas de cor, linguagem simples e suporte a `prefers-reduced-motion`.
